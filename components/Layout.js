  ...
  return (
    <PasswordGate>
      <div className="flex flex-col h-screen overflow-hidden">
        {/* Mobile top nav — hidden on home (WelcomeScreen has its own header) */}
        {!isHome && (
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <main className={`flex-1 overflow-y-auto ${isHome ? 'bg-slate-950' : 'bg-white'}`}>
        ...
        {/* Mobile sidebar overlay — only on step pages */}

    ...
    <div className="px-4 py-8 md:px-10 md:py-12">
      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* ── Always-visible: Showing Tracker ── */}
          <div className="mt-10 pt-8 border-t border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">Your Showing Log</h3>
            <p className="text-sm text-gray-500 mb-4">Keep a running log of who visited and when — add entries as showings happen.</p>
        ...
        <aside className="hidden lg:block w-64 flex-shrink-0 sticky top-4 space-y-4">
          ...
          {/* Card 2 sidebar: all 4 pro tips + Home Depot */}
          {activeSubStep === 2 && (
            <>
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                <h4 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">Resources</h4>
                <div className="space-y-1.5">
                  {[{ label: 'Home Depot lockbox', url: 'https://homedepot.com' }].map(({ label, url }) => (
                    <a
                      key={label}
                      href={url}
                      target="_blank"
